...
<form method="POST" class="row g-3">
  ...
  <div class="col-md-6 pb-2">
    ...
    <input type="text" id="ingredients" name="ingredients" required maxlength="1000">
  </div>
  <div class="col-12 pb-2">
    <label for="preparation" class="form-label">Préparation</label>
    <input type="text" id="preparation" name="preparation" required maxlength="1000">
  </div>

  <div class="col-md-4 pb-2">
    <label for="theme" class="form-label">Province</label>
